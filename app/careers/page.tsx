        ...
        <div className="min-h-screen bg-background font-sans">
            ...
            <section className="pt-40 pb-20 bg-primary text-white relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10 text-center max-w-4xl">
                    <motion.div {...fadeIn}>
                        <span className="inline-block py-1 px-4 rounded-full bg-[#D4AF37]/10 text-[#D4AF37] border border-[#D4AF37]/20 text-xs font-bold uppercase tracking-widest mb-6">
                            Join Navagatha Tech
                        </span>
                        <h1 className="text-4xl md:text-6xl font-extrabold mb-8 leading-tight">
                            Build the Future of <br />
                            <span className="text-[#D4AF37]">Enterprise Technology</span>
                        </h1>
